  ...
  const CartaoSection = () => (
    <View style={styles.cartaoContainer}>
      <View style={styles.cartao}>
        ...
        <Text style={styles.cargoCartao}>
          {userData.cargo || 'Seu Cargo'}
        </Text>

        <View style={styles.biografiaContainer}>
          <Text style={styles.biografiaCartao}>
            {userData.biografia || 'Adicione uma biografia para contar um pouco sobre você, suas habilidades e experiências profissionais.'}
          </Text>
        </View>
      </View>
    </View>
